...
def trigger_task(zap_id):
    try:
        ...
        apps_error_logger.info("GoogleApps:Tasks:TriggerFailureException:ZapID="+str(zap_id)+":"+str(e), exc_info=True)
...
def action_task(trigger_info, zap_id):
    try:
        ...
        apps_error_logger.info("GoogleApps:Tasks:ActionFailureException:ZapID="+str(zap_id)+":"+str(e), exc_info=True)
